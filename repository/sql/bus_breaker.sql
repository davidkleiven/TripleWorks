WITH terminal_substation AS (
	...
	INNER JOIN v_voltage_levels_latest v ON c.connectivity_node_container_mrid = v.mrid
)
SELECT l.mrid, l.r, l.x, b.nominal_voltage, ts.substation_mrid, t.sequence_number
