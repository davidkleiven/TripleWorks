...
type TerminalOperations struct {
	ConnectivityNodeMrid uuid.UUID `bun:"connectivity_node_mrid,type:uuid" json:"connectivity_node_mrid"`
...
type LoadGroupOperations struct {
	SubLoadAreaMrid uuid.UUID `bun:"sub_load_area_mrid,type:uuid" json:"sub_load_area_mrid"`
	SubLoadArea     *Entity   `bun:"rel:belongs-to,join:sub_load_area_mrid=mrid" json:"sub_load_area,omitempty"`
}

type AnalogLimit struct {
	Limit
	LimitSetMrid uuid.UUID `bun:"limit_set_mrid,type:uuid" json:"limit_set_mrid"`
...
type DiscreteValue struct {
	...
	DiscreteMrid uuid.UUID `bun:"discrete_mrid,type:uuid" json:"discrete_mrid"`
	Discrete     *Entity   `bun:"rel:belongs-to,join:discrete_mrid=mrid" json:"discrete,omitempty"`
}
type RaiseLowerCommand struct {
	AnalogControl
	ValueAliasSetMrid uuid.UUID `bun:"value_alias_set_mrid,type:uuid" json:"value_alias_set_mrid"`
...
type AccumulatorLimitSet struct {
	LimitSet
	MeasurementsMrid uuid.UUID `bun:"measurements_mrid,type:uuid" json:"measurements_mrid"`
...
type SubLoadArea struct {
	EnergyArea
	LoadAreaMrid uuid.UUID `bun:"load_area_mrid,type:uuid" json:"load_area_mrid"`
	LoadArea     *Entity   `bun:"rel:belongs-to,join:load_area_mrid=mrid" json:"load_area,omitempty"`
}
type SwitchSchedule struct {
	SeasonDayTypeSchedule
	SwitchMrid uuid.UUID `bun:"switch_mrid,type:uuid" json:"switch_mrid"`
...
type AccumulatorValue struct {
	MeasurementValue
	AccumulatorMrid uuid.UUID `bun:"accumulator_mrid,type:uuid" json:"accumulator_mrid"`
...
type Season struct {
	IdentifiedObject
	EndDateMrid   uuid.UUID `bun:"end_date_mrid,type:uuid" json:"end_date_mrid"`
	EndDate       *Entity   `bun:"rel:belongs-to,join:end_date_mrid=mrid" json:"end_date,omitempty"`
	StartDateMrid uuid.UUID `bun:"start_date_mrid,type:uuid" json:"start_date_mrid"`
	StartDate     *Entity   `bun:"rel:belongs-to,join:start_date_mrid=mrid" json:"start_date,omitempty"`
}
type Bay struct {
	EquipmentContainer
	VoltageLevelMrid uuid.UUID `bun:"voltage_level_mrid,type:uuid" json:"voltage_level_mrid"`
	VoltageLevel     *Entity   `bun:"rel:belongs-to,join:voltage_level_mrid=mrid" json:"voltage_level,omitempty"`
}
type AnalogValue struct {
	MeasurementValue
	AnalogMrid uuid.UUID `bun:"analog_mrid,type:uuid" json:"analog_mrid"`
...
type Measurement struct {
	IdentifiedObject
	PowerSystemResourceMrid uuid.UUID       `bun:"power_system_resource_mrid,type:uuid" json:"power_system_resource_mrid"`
...
type TapSchedule struct {
	SeasonDayTypeSchedule
	TapChangerMrid uuid.UUID `bun:"tap_changer_mrid,type:uuid" json:"tap_changer_mrid"`
	TapChanger     *Entity   `bun:"rel:belongs-to,join:tap_changer_mrid=mrid" json:"tap_changer,omitempty"`
}
type ConnectivityNode struct {
	IdentifiedObject
	ConnectivityNodeContainerMrid uuid.UUID `bun:"connectivity_node_container_mrid,type:uuid" json:"connectivity_node_container_mrid"`
...
type MeasurementValue struct {
	IdentifiedObject
	MeasurementValueSourceMrid uuid.UUID `bun:"measurement_value_source_mrid,type:uuid" json:"measurement_value_source_mrid"`
...
type MeasurementValueQuality struct {
	Quality61850
	MeasurementValueMrid uuid.UUID `bun:"measurement_value_mrid,type:uuid" json:"measurement_value_mrid"`
